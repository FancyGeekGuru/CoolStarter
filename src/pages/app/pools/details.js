  ...
  return (
    <>
      ...
      <Section title="Avania" description='Avania is a game where you can earn a token by contributing your talent to the game such as playing the game, awaken nexus, building community, supporting other players, supporting the game, etc. Avania will be a place to build the greatest GameFi community through well-designed gameplay. The key factor that makes Avania different from other traditional online games is the “Play to Earn” concept that takes advantage of blockchain technology. Everyone in the world can enjoy the game while also experiencing a new way of making some income.'>
        ...
        <div className="text-center flex justify-center pt-4 pb-10">
          <h2 className='token'>NIVA</h2>
        </div>

        <div className="text-center flex justify-center pb-20">
          <div className='grid sm:grid-cols-3 gap-6'>
            <Button>Join Whitelist</Button>
            <Button>Pass Kyc</Button>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
          ...
          <div className="pl-8 pr-8 p-4 flex-col flex bg-gray-800 card rounded-md text-white " style={{ border: "1px solid gray" }}>
            <div>
              <h1 className="pb-4 text-lg ">USER INFORMATION</h1>
              <hr aria-orientation="horizontal" className="pt-4"></hr>
            </div>
            <div>
              <span className="pb-4">Tier</span>
              <span className="pb-4 float-right">Not connected</span>
            </div>
            <div>
              <span className="pb-4">Is whitelisted</span>
              <span className="pb-4 float-right">TBD</span>
            </div>
            <div>
              <span className="pb-4">1st round allocation left</span>
              <span className="pb-4 float-right">TBD</span>
            </div>
            <div>
              <span className="pb-4">FCFS allocation left</span>
              <span className="pb-4 float-right">TBD</span>
            </div>
          </div>
          ...
          <div className="pl-8 pr-8 p-4 flex-col flex bg-gray-900 card rounded-md text-white" style={{ border: "1px solid gray" }}>
            <div>
              <h1 className="pb-4 text-lg">TOKEN INFORMATION</h1>
              <hr aria-orientation="horizontal" className="pt-4"></hr>
            </div>
            <div>
              <span className="pb-4">Token Ticker</span>
              <span className="pb-4 float-right">NIVA</span>
            </div>
            <div>
              <span className="pb-4">Token chain</span>
              <span className="pb-4 float-right">
            ...
            <div>
              <span className="pb-4">Token price</span>
              <span className="pb-4 float-right">1 BUSD = 10 NIVA</span>
            </div>
          </div>
        </div>
      </Section>
